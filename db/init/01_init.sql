...
--
-- Seed additions (previously in db/init/02_seed_extra.sql)
-- Kept here so a fresh "docker compose up" yields identical demo data for all teammates.
--
...
INSERT INTO public.menu_items (id, restaurant_id, name, description, price, currency, is_active, is_available, image_url, created_at, updated_at, listing_mode, ref_category_id, is_brand_anonymous, base_price, discount_percent, discount_fixed, composition)
VALUES
...
-- Ensure sequences are ahead of inserted demo IDs
